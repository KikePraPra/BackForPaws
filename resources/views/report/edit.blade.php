...
<body>
    <main class="bg-white">
        <article class="min-h-screen flex items-center justify-center flex-col rounded-3xl bg-white px-7 pt-10 z-10">
            <h1 class="text-3xl font-bold text-green-700">Edit Report</h1>
            <div class="mt-11 flex flex-col gap-7">
                ...
                <form method="POST" action="{{ route('report.update', $report->id) }}" enctype="multipart/form-data" class="flex flex-col w-max mx-auto font-sans">
                    ...
                    <label class="mt-2">Account:</label>
                    ...
                    <label class="mt-6">Animal type:</label>
                    ...
                    <label class="mt-6">Last seen place:</label>
                    ...
                    <select name="pet_state" required class="rounded-lg border-2 border-green-600 h-12 w-80 mt-2 pl-2 text-lg font-semibold">
                        ...
                        <option value="Lost" {{ old('pet_state', $report->pet_state) == 'Lost' ? 'selected' : '' }}>Lost</option>
                        <option value="Found" {{ old('pet_state', $report->pet_state) == 'Found' ? 'selected' : '' }}>Found</option>
                        <option value="Other" {{ old('pet_state', $report->pet_state) == 'Other' ? 'selected' : '' }}>Other</option>
                    </select>
